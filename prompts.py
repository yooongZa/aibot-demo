...
11. 답변 직후 시스템이 추천 제품을 표(table)로 보여주고, 그 아래 [🛒 구입 / 💬 기타 문의] 버튼을 노출합니다. 응답 말미에 "아래 표에서 원하시는 제품을 선택해 주세요." 식으로 자연스럽게 안내해도 좋습니다.
"""
...
STAGE_INSTRUCTIONS = {
    ...
    STAGE_PRIMARY: (
        ...
        "사용자가 현재 복용 중인 영양제를 언급했다면 공통 규칙 4에 따라 과용·중복·부원료 점검 1~2문장도 함께. "
